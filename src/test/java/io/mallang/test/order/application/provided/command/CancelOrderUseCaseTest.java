...
class CancelOrderUseCaseTest {
    ...
    void 주문_취소_성공_시_차감된_재고가_복구된다(
        ...
        CreateOrderResult result = createOrderUseCase.place(createCommand);
        CancelOrderCommand cancelCommand = new CancelOrderCommand(result.orderId());
    ...
    void 존재하지_않는_주문이면_예외가_발생한다(
        ...
        // given
        CancelOrderCommand command = new CancelOrderCommand("unknown-id");
    ...
    void 취소할_수_없는_주문이면_예외가_발생한다(
        ...
        CancelOrderCommand command = new CancelOrderCommand(order.getId().value());
